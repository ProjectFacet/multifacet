...
#
#     Different from Discussions because there are specified users.
#
#     Direct messages can be sent to a specific user, group of users and will only be
#     visible to those users in their conversations.
#     """
#
...
#         help_text = 'The exchange of users this message is meant for.',
