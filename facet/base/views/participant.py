...
#     """Creating a new Participant before creating specific profile association.
#     """
#
#     model = Participant
...
#         """Save participant -- but first set a few values."""
#
#         participant = self.object = form.save(commit=False)
#         # if form for StaffJournalist
